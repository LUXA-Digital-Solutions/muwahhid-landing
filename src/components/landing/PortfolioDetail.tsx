...
import { ArrowLeft, Calendar, ExternalLink, ArrowRight, Eye, Palette, Layers, Target, Clock, Users, Award, Play, Pause } from "lucide-react";
...
const portfolioData: PortfolioProject[] = [
  {
    ...
    challenge: "Create a comprehensive brand identity that reflects the company's innovative approach while maintaining professional credibility in the competitive tech market.",
    solution: "Developed a modern, scalable brand system featuring a geometric logo that represents connectivity and growth, accompanied by a sophisticated color palette and typography hierarchy that ensures consistency across all touchpoints.",
    process: [
  ...
  },
  {
    ...
    challenge: "Design a cohesive digital marketing campaign that maintains brand consistency while adapting to different social media platforms and formats.",
    solution: "Created a flexible design system with modular components that could be easily adapted for various platforms, ensuring visual consistency while optimizing for each medium's unique requirements.",
    process: [
  ...
  },
  {
    ...
    challenge: "Design sustainable packaging that balances environmental responsibility with luxury appeal and functional requirements.",
    solution: "Created packaging using recycled materials with innovative folding techniques that reduced material waste while maintaining premium aesthetics and protecting product integrity.",
    process: [
    ...
    tools: ["Adobe Illustrator", "Adobe Photoshop", "3D Modeling Software", "Physical Prototyping"],
...
const PortfolioDetail = ({ projectId }: { projectId: number }) => {
    ...
    return (
      <div className="min-h-screen bg-brand-cream text-brand-forest flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl md:text-3xl font-bold text-brand-forest mb-4">Project Not Found</h1>
          <p className="text-brand-forest/80 mb-8">The project you're looking for doesn't exist.</p>
          <a 
            href="/portfolio" 
  ...
  return (
    <div className="min-h-screen bg-brand-cream text-brand-forest">
      {/* Header */}
      <div className="relative bg-gradient-to-b from-brand-cream via-brand-cream/95 to-brand-olive/10 border-b border-brand-forest/20">
        ...
        <div className="container relative z-10 px-4 sm:px-6 py-16 md:py-20">
          <div className="max-w-4xl mx-auto">
            ...
            <a 
              href="/portfolio" 
              className="inline-flex items-center gap-2 text-brand-forest/70 hover:text-brand-green transition-colors duration-300 mb-8 group"
            >
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-brand-forest/10">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-semibold text-brand-forest">Project Results</h3>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div className="space-y-4">
                  {project.process.map((step, index) => (
                    <div key={index} className="flex items-start gap-4">
                      ...
                      <p className="text-brand-forest/80 leading-relaxed">{step}</p>
                    </div>
                  ))}
                </div>
              </section>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-brand-green to-brand-olive text-white rounded-2xl p-6 text-center">
              <h3 className="font-semibold mb-3">Ready to start your project?</h3>
